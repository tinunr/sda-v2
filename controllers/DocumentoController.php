...
class DocumentoController extends Controller
{
     ...
     * @return mixed
     */
    public function actionGetNumber($documento_id, $data=null){
        Yii::$app->response->format = \yii\web\Response::FORMAT_JSON;                
        $documentoNumero = DocumentoNumero::findByDocumentId($documento_id, $data);
        return  $documentoNumero->getNexNumber();
    }
}
