...
$this->registerJsFile(Url::to('@web/js/app/cnt/cnt_razao_create.js'),['position' => \yii\web\View::POS_END]);
$this->registerCss("
...
<div class="row">
    ...
    ?>
     ...
     <div class="col-md-2">
        ...
        'options' => ['placeholder' => '','id'=>'bas_mes_id'],
        'pluginOptions' => [
            'allowClear' => false,
        ],        
    ]);?>
    ...
    <div class="col-md-2">
        ...
        'options' => ['placeholder' => '','id'=>'bas_ano_id'],
        'pluginOptions' => [
            'allowClear' => false,
        ],        
    ]);?>
    ...
    <div class="col-md-3">
        ...
        'options' => ['placeholder' => '','id'=>'cnt_diario_id'],
        'pluginOptions' => [
            'allowClear' => true,
        ],        
    ]);?>
