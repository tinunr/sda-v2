...
?>
    ...
    <div class="col-md-12">
    <?= $form->field($model,'bas_template_id')->inline()->radioList(['1'=>'Por Conta', '2'=>'Por Fornecedor'])->label('Template'); ?>
    </div>
     <div class="col-md-4">
    ...
    <div class="col-md-12">
    <?= $form->field($model,'bas_formato_id')->inline()->radioList(['1'=>'PDF','EXCEL'])->label('Formato'); ?>
    </div>
