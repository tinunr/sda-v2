    ...
    <table class="table tabe-striped ">
        ...
        <tbody>
            <?php foreach ($palnaoConta as $key => $model):?>
                ...
                <?php
                    $debitoAtual = Yii::$app->CntQuery->getDebitoAtual($model->id,$data['RazaoItemSearch']['begin_ano'],$data['RazaoItemSearch']['begin_mes'],$data['RazaoItemSearch']['cnt_plano_terceiro_id'],$data['RazaoItemSearch']['bas_formato_id']);
                    $creditoAtual = Yii::$app->CntQuery->getCreditoAtual($model->id,$data['RazaoItemSearch']['begin_ano'],$data['RazaoItemSearch']['begin_mes'],$data['RazaoItemSearch']['cnt_plano_terceiro_id'],$data['RazaoItemSearch']['bas_formato_id']);

                ?>
                <?php if($debitoAtual >0||$creditoAtual>0):?>
                <?php
                    $debitoAnteriro = Yii::$app->CntQuery->getDebitoAnterior($model->id,$data['RazaoItemSearch']['begin_ano'],$data['RazaoItemSearch']['begin_mes'],$data['RazaoItemSearch']['cnt_plano_terceiro_id'],$data['RazaoItemSearch']['bas_formato_id']);
                    $creditoAnterior = Yii::$app->CntQuery->getCreditoAnterior($model->id,$data['RazaoItemSearch']['begin_ano'],$data['RazaoItemSearch']['begin_mes'],$data['RazaoItemSearch']['cnt_plano_terceiro_id'],$data['RazaoItemSearch']['bas_formato_id']);
