...
/**
 * DocumentoDespachoSearch represents the model behind the search form of `app\models\DespachoDocumento`.
 */
class DocumentoDespachoSearch extends DespachoDocumento
{
    public $globalSearch;
