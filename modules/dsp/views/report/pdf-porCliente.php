...
<p style="padding: 5px; border-bottom: 1px solid #ddd; font-size: 12px; margin-top: 25px; text-transform: uppercase;font-weight: 700; color: #444444;"><?=$cliente['nome']?></p>
<table style=" border-collapse: collapse;width: 100%;">
<?php 
$provider = \app\modules\dsp\services\DspService::processPdfReport($user_id,$status,$cliente['id'],$bas_ano_id,$dataInicio,$dataFim,$comPl);
?>
<tr>
  <th style="padding: 4px; text-align: left;border-bottom: 1px solid #ddd; font-size: 12px;">Nº Pro.</th>
	<th style="padding: 4px; text-align: left;border-bottom: 1px solid #ddd; font-size: 12px;">NORD</th>
	<th style="padding: 4px; text-align: left;border-bottom: 1px solid #ddd; font-size: 12px;">Estado</th>
	<th style="padding: 4px; text-align: left;border-bottom: 1px solid #ddd; font-size: 12px;">Mercadoria</th>
  <th style="padding: 4px; text-align: left;border-bottom: 1px solid #ddd; font-size: 12px;">Obs</th>
...
<?php foreach($provider->getModels() as $model):?>
  <tr>
    ...
    <td style="padding: 2px; text-align: left;border-bottom: 1px solid #ddd;  font-size: 11px;"><?=!empty($model->nord->despacho->data_liquidacao)?$model->nord->despacho->data_liquidacao:''?>
    </td>
