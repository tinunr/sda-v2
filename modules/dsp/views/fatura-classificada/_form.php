    ...
    <div class="row">
        ...
        <div class="row">
            <?php DynamicFormWidget::begin([
                ...
                'model' => $modelsFaturaClassificada[0],
                'formId' => 'dynamic-form',
                'formFields' => [
                    'item_descricao',
                    'valor',
            ...
            <table class="container-items table table-hover">
                ...
                <?php foreach ($modelsFaturaClassificada as $i => $item) : ?>
                ...
                <tr class="item">
                    ...
                    <td>
                        <?= $form->field($item, "[{$i}]nomeclatura")->textInput()->label(false); ?>
                    </td>
                    <td style="width: 100px">
                        <?= $form->field($item, "[{$i}]quantidade")->textInput(['maxlength' => true])->label(false) ?>
                    </td>
                    <td style="width: 100px">
                        <?= $form->field($item, "[{$i}]peso_liquido")->textInput(['maxlength' => true])->label(false) ?>
                    </td>
                    <td style="width: 100px">
                        <?= $form->field($item, "[{$i}]peso_bruto")->textInput(['maxlength' => true])->label(false) ?>
                    </td>
                    <td style="width: 100px">
