...
$this->title = 'Recolocação do Processo em bloco';
?>
<section>
    <div class="Curso-index">
      ...
      'action' => Url::toRoute(['/dsp/processo-workflow/realocar-box']),
    ]);
    ?>
        <div class="row">
            <div class="col-md-6">
      ...
      'columns' => [
        ...
        <div class="navbar-fixed-bottom">
            ...
            <div class="col-md-2 ">
                <?= Html::submitButton('<i class="fa fa-share"></i> Realocar', ['id' => 'avancar', 'class' => 'btn btn-info', 'style' => ['display' => 'none']]); ?>
            </div>
        </div>
        <?php endif; ?>
        <?php ActiveForm::end(); ?>
