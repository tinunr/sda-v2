...
?>
    ...
    <div class="col-md-2">
     <?= $form->field($model, 'fin_recebimento_tipo_id')->widget(Select2::classname(), [
         'theme' => Select2::THEME_BOOTSTRAP,
         'data' => ArrayHelper::map(RecebimentoTipo::find()->orderBy('descricao')->all(), 'id', 'descricao'),
    ...
    <div class="col-md-2">
        <?= $form->field($model, 'globalSearch')->textInput(['placeholder'=>'RCB / VALOR'])->label(false) ?>
    </div>
