...
<p style="text-align: left; padding: 7px; height:6px"><i class="fa fa-graduation-cap"></i> Ilmo. Sr <?= $model->person->nome?>
 ...
 <p style="text-align: left; padding: 7px; height:6px"><i class="fa fa-graduation-cap"> Recebemos em <?= $model->documentoPagamento->descricao.' - '.  $model->numero_documento .' - '. $model->banco->descricao ?> pelos siguente(s) documento(s)</p>
 <section>
 ...
 <?php $i=1; foreach ($model->recebimentoItem as $key => $item):?>
    ...
    <tr>      
      <td style="text-align: left; padding: 3px; border: 0px"> <?=$item->descricao_item?></td>
      <td style="text-align: center;padding: 3px;border: 0px"> <?= number_format($item->valor,2)?> </td>
      <td style="text-align: center;padding: 3px;border: 0px"> <?= number_format($item->valor,2)?> </td>
      <td style="text-align: center;padding: 3px;border: 0px"> <?= date("d-m-Y", strtotime($model->data))?> </td>
      <td style="text-align: center;padding: 3px;border: 0px"> 0 </td>
    </tr>
