...
$this->registerJsFile(Url::to('@web/js/src/fin_fatura_proforma.js'), ['position' => \yii\web\View::POS_END]);
...
<div class="desciplina-perfil-form">
    ...
    <div class="row">
        <div class="row">
            ...
            <div class="col-md-2">
                <?= $form->field($model, 'dsp_processo_id')->widget(Select2::classname(), [
                    ...
                    'options' => ['placeholder' => 'PROCESSO', 'id' => 'dsp_processo_id', 'onchange' => 'finFaturaProformaDetNordData(this)'],
                    'pluginOptions' => [
                        'allowClear' => true,
            ...
            <div class="col-md-2">
                <?= $form->field($model, 'nord')->widget(Select2::classname(), [
                    'theme' => Select2::THEME_BOOTSTRAP,
                    'options' => ['placeholder' => 'NORD', 'id' => 'nord'],
                    'pluginOptions' => [
                        'allowClear' => true,
                        'minimumInputLength' => 1,
                        'ajax' => [
            ...
            'ajax' => [
             ...
             <div class="col-md-2">
                <?php echo $form->field($model, 'data')->widget(DatePicker::classname(), [
                    ...
                    'pickerButton' => true,
                    'options' => ['id' => 'data', 'onchange' => 'finFaturaProformaDetNordData(this)'],
                    'pluginOptions' => [
                        'format' => 'yyyy-mm-dd',
                        'autoclose' => true,
                        'todayHighlight' => true,
        ...
        <div class="row">
            <div class="titulo-principal">
             ...
             <div class="row"> 
                ...
                <div class="col-md-3">
                    <?= $form->field($model, 'deslocacao_transporte')->textInput(['id' => 'deslocacao_transporte', 'onchange' => 'getRegimeData(this)']) ?>
                </div>
                <div class="col-md-3">
                    <?= $form->field($model, 'impresso')->textInput(['id' => 'impresso', 'onchange' => 'getRegimeData(this)']) ?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <?php DynamicFormWidget::begin([
                ...
                'model' => $modelsFaturaProformaItem[0],
                'formId' => 'dynamic-form',
                'formFields' => [
                    'dsp_item_id',
                    'valor',
            ...
            <table class="container-items table table-hover">
                ...
                <?php foreach ($modelsFaturaProformaItem as $i => $item) : ?>
    ...
    function updateTotal() {
        ...
        for (var i = 0; i <= $('#hidemCount').val(); i++) {
            if ($("#faturaproformaitem-" + i + "-valor").val() > 0) {
                var total = parseFloat(total) + parseFloat($("#faturaproformaitem-" + i + "-valor").val());
            }
        }
        $("#total").val(total);
    }
