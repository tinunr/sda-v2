...
<div class="titulo-principal"> <h5 class="titulo"><?=$persondata['personName']?></h5><div id="linha-longa"><div id="linha-curta"></div></div> </div>
 ...
 <table class="table table-striped">
  ...
  <tbody>
    ...
    $searchModel = new app\modules\fin\models\FaturaProvisoriaSearch($data['ReportSearch']);
    ...
    <tr>
      ...
      <td><?php $saldo = ($value['valor_recebido']<$value['valor_despesa'])?($value['total_pago']-$value['valor_recebido']):($value['total_pago']-$value['valor_despesa']);
