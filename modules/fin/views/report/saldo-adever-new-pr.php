 ...
 <table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <?php //$saldo = ($value['valor_recebido']<$value['valor_despesa'])?($value['total_pago']-$value['valor_recebido']):($value['total_pago']-$value['valor_despesa']);
      $total_saldo = $total_saldo + $value['saldo'];

      ?>
      <?=$formatter->asCurrency($value['saldo'])?>
