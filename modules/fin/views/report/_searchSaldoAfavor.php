...
?>
  <div class="row">
    ...
    <div class="col-md-12">
         ...
         'data' => ArrayHelper::map(Documento::find()->where(['id'=>[Documento::PROCESSO_ID,Documento::FATURA_PROVISORIA_ID,Documento::RECEBIMENTO_ID,Documento::AVISO_CREDITO,Documento::NOTA_CREDITO_ID]])->orderBy('descricao')->all(), 'id', 'descricao'),
