...
<p>
<?=Html::a('Imprimir',['valor-adever-pdf'],['class'=>'btn btn-success','target'=>'_blank'])?>
 ...
 <table class="table table-striped table-hover">
  <thead>
    <tr>
      ...
      <th title="Valor total item da Despesa na FP [ e ] ">Valor Item Despesa</th>
      <th title="Devolução da Alfândega - Favor Cliente [ f ] ">Dev. da Alfândega</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?=$formatter->asCurrency(abs($value['saldo']))?></td> 
    </tr>
  <?php endforeach;?>
  </tbody>
  <tfoot>
