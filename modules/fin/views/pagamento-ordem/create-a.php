...
<section>
  <div class="Curso-index">
    <?php echo Html::a('<i class="fas fa-arrow-left"></i>', ['index'], ['class' => 'btn btn-warning', 'title' => 'VOLTAR']) ?>
  ...
  <?= Html::beginForm(['/fin/pagamento-ordem/create']); ?>
...
<script type="text/javascript">
  function updateForm() {
    ...
    if (keys == '') {
      ...
      $.getJSON("/fin/pagamento/validar-person", {
        keys: keys
      }, function(data) {
        if (data.isValid == 1) {
