...
<p style="margin: 0px 0px; text-align: center; padding: 2px; font-size: 90%;"><strong><i class="fa fa-graduation-cap"></i>  <?= $company['name']?></strong>
    ...
    <p style="margin: 0px 0px; text-align: center; padding:0px;font-size: 80%;"><strong><i class="fa fa-graduation-cap"></i> RECIBO Nº <?=$model->numero?></strong>
    </p>
...
<p style="text-align: left; padding: 7px; height:6px"><i class="fa fa-graduation-cap"></i> Ilmo. Sr <?= $model->person->nome?>
</p>

 <p style="text-align: left; padding: 7px; height:6px"><i class="fa fa-graduation-cap"> Recebemos em <?= $model->documentoPagamento->descricao.' - '.$model->numero_documento.' - '.$model->banco->sigla ?> pelos siguente(s) documento(s)</p>
 <section>
 ...
 <?php $i=1; foreach ($model->item as $key => $item):?>
    ...
    <tr>      
      <td style="text-align: left; padding: 3px; border: 0px"> <?=$item->despesa->numero.' - '.$item->despesa->descricao?></td>
      <td style="text-align: right;padding: 3px;border: 0px"> <?= number_format($item->valor,2)?> </td>
      <td style="text-align: right;padding: 3px;border: 0px"> <?= number_format($item->valor_pago,2)?> </td>
      <td style="text-align: right;padding: 3px;border: 0px"> <?= number_format($item->saldo,2)?> </td>
    </tr>
...
<table class="table table-hover">  
  <tbody>   
    <tr> 
      <td style="text-align: right;padding: 3px;vertical-align: top; border-top: 0px">
