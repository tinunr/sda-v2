...
$this->registerJsFile(Url::to('@web/js/of_accounts_b.js'),['position' => \yii\web\View::POS_END]);
$total_valor = 0;
                ...
                <table class="container-items table table-hover">
                 ...
                 <?php foreach ($modelsReceita as $i => $item): ?>
                     ...
                     <?php
                                ...
                                $valor_recebido_old =  $item->valor_recebido;
                                $saldo_old =  $item->saldo;
                                $item->valor_recebido = 0;
                                $item->valor = $item->saldo;
                                $item->saldo = $item->saldo - $item->valor_recebido;
                        ...
                        <tr class="item" >
                          ...
                          <td >
                            <?= $form->field($item, "[{$i}]valor_recebido")->textInput(['onchange'=>'updateData(this)','disabled'=>true])->label(false) ?>
                            <?=Html::hiddenInput('valor_recebido_old', $valor_recebido_old,['id'=>'valor_recebido_old','class' => 'form-control']);?>
