...
$this->registerJsFile(Url::to('@web/js/src/fin_fatura_provisoria.js'), ['position' => \yii\web\View::POS_END]);
    ...
    <div class="row">
        <div class="row">
            ...
            <div class="col-md-2">
                <?php echo $form->field($model, 'data')->widget(DatePicker::classname(), [
                    ...
                    'pickerButton' => true,
                    'options' => ['id' => 'data', 'onchange' => 'finFaturaProvisoriaDetNordData(this)'],
                    'pluginOptions' => [
                        'format' => 'yyyy-mm-dd',
                        'autoclose' => true,
                        'todayHighlight' => true,
            ...
            <div class="col-md-2">
                <?= $form->field($model, 'dsp_processo_id')->widget(Select2::classname(), [
                    ...
                    'options' => ['placeholder' => 'PROCESSO', 'id' => 'dsp_processo_id', 'onchange' => 'finFaturaProvisoriaDetNordData(this)'],
                    'pluginOptions' => [
                        'allowClear' => true,
        ...
        <div class="row">
            ...
            <table class="container-items table table-hover">
             ...
             <tfoot>
                <tr>
                    <th><button id="add-item" onclick="addNullItem();" value=<?= $i ?> type="button"
                class="add-item btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i></button>
                    <?= Html::hiddenInput('hidemCount', $i, ['id' => 'hidemCount', 'class' => 'form-control']); ?></th>
                    <th>TOTAL</th>
