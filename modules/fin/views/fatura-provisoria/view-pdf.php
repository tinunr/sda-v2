...
<div class="col-md-6" style="width: 525px; float: left;"
    ...
    <div id="invoice">
        ...
        <div id="company">
            <h1>FATURA PROVISÓRIA Nº <?=$model->numero.'/'.$model->bas_ano_id?></h1>
    ...
    <table class="pdf">
        ...
        <tbody>
            <?php $i=0; foreach ($model->faturaProvisoriaItem as $key => $modelItem) :?>
            <tr>
                <td class="pdf desc" colspan="2">
                    <?=str_pad($modelItem->item->id,2,'0',STR_PAD_LEFT).' - '.$modelItem->item->descricao?></td>
