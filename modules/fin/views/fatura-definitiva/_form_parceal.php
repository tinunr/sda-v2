...
$this->title = 'Nova fatura definitiva normal';
 ...
 $this->registerJsFile(Url::to('@web/js/src/fin_fatura_defenitiva_parceal.js'),['position' => \yii\web\View::POS_END]);
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            'ajax' => [
                ...
                <div class="col-md-3">
                    <?= $form->field($model, 'deslocacao_transporte')->textInput(['id' => 'deslocacao_transporte']) ?>
                </div>
                <div class="col-md-3">
                    <?= $form->field($model, 'impresso')->textInput(['id' => 'impresso']) ?>
                </div>
