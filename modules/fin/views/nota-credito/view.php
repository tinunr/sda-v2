...
<div class="titulo-principal"> <h5 class="titulo">Aviso de credito</h5><div id="linha-longa"><div id="linha-curta"></div></div> </div>
...
<!-- valores despachante -->
<?php if ($model->fin_fatura_defenitiva_id) :?>
     
      <p><strong>Recebimento</strong></p>
      <table class="table">
          <tr>
            <th class="pdf desc">Fatura Provisória</th>
            <th class="pdf desc">Data Fatua</th>
            <th class="pdf desc">Recebimento</th>
            <th class="pdf desc">Data Rcebimento</th>
        ...
        ?>
          <tr>
            ...
            <td class="pdf desc"><?=$value['recibos']?></td> 
            <td class="pdf desc"><?=$formatter->asDate($value['data_recebimento'])?></td> 
      ...
      <table class="table">
          <tr>
            ...
            <th class="pdf total">Total Recebido</th>
            <th class="pdf total">Diferença</th>
          </tr>
        <tbody>
        <tr>
            ...
            <td class="pdf date"><?=$formatter->asCurrency($model->faturaDefinitiva->valor)?></td>
            <td class="pdf total"><?=$formatter->asCurrency($total_recebido) ?></td>
            <td class="pdf total"><?=$formatter->asCurrency(abs($model->faturaDefinitiva->valor - $total_recebido))?></td>
          </tr>
        </tbody>
         <tfoot>
          <tr>
            <td class="pdf no" colspan="4">Valor de Aviso de Credito</td>
