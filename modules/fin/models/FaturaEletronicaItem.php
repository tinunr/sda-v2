 ...
 */
class FaturaEletronicaItem extends \yii\db\ActiveRecord
{
    ...
    {
        return 'fin_fatura_eletronica_item';
    }
    ...
    {
        return [
            [['fin_fatura_eletronica_id', 'dsp_item_id'], 'required'],
            [['fin_fatura_eletronica_id', 'dsp_item_id'], 'integer'],
            [['valor'], 'double'],
    ...
    {
        return [
            'fin_fatura_eletronica_id' => 'Fatura Definitiva',
            'dsp_item_id' => 'Item',
            'valor' => 'Valor',
    ...
    {
        return $this->hasOne(FaturaEletronica::className(), ['id' => 'fin_fatura_eletronica_id']);
    }
