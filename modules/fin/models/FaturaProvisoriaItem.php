 ...
 */
class FaturaProvisoriaItem extends \yii\db\ActiveRecord
{
   ...
   const ITEM_ORIGEM_D = 'D';
    ...
    {
        return 'fin_fatura_provisoria_item';
    }
    ...
    */
    ...
    {
        return [
            [['dsp_fatura_provisoria_id', 'dsp_item_id','valor'], 'required'],
            [['dsp_fatura_provisoria_id', 'dsp_item_id','item_row'], 'integer'],
