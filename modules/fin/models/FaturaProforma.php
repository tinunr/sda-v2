...
use app\modules\fin\behaviors\FaturaProformaBehavior;
 ...
 */
class FaturaProforma extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function behaviors()
    {
        return [
            ...
            'fprof' => [
                'class' => FaturaProformaBehavior::className(),
            ]
    ...
    {
        return [
            [['data', 'dsp_person_id', 'mercadoria', 'dsp_processo_id'], 'required'],
            [['numero', 'dsp_person_id', 'impresso_principal', 'dsp_regime_id', 'dsp_regime_item_id', 'dsp_processo_id', 'dv', 'tce', 'pl', 'tn', 'gti', 'fotocopias', 'qt_estampilhas', 'form', 'regime_normal', 'regime_especial', 'exprevio_comercial', 'expedente_matricula', 'taxa_comunicaco', 'bas_ano_id', 'fin_fatura_provisoria_id'], 'integer'],
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getFaturaProformaItem()
    {
        return $this->hasMany(FaturaProformaItem::className(), ['dsp_fatura_proforma_id' => 'id'])->orderBy(['dsp_item_id' => SORT_ASC]);
    }
    ...
    {
        return $this->hasOne(FaturaProvisoria::className(), ['fin_fatura_proforma_id' => 'id']);
    }
}
