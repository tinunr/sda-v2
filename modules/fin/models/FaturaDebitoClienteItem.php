 ...
 */
class FaturaDebitoClienteItem extends \yii\db\ActiveRecord
{
    ...
    {
        return 'fin_fatura_debito_cliente_item';
    }
    ...
    {
        return [
            [['fin_fatura_debito_cliente_id', 'dsp_item_id'], 'required'],
            [['fin_fatura_debito_cliente_id', 'dsp_item_id'], 'integer'],
            [['valor'], 'double'],
    ...
    {
        return [
            'fin_fatura_debito_cliente_id' => 'Debito Cliente',
            'dsp_item_id' => 'Item',
            'valor' => 'Valor',
    ...
    {
        return $this->hasOne(FaturaDefinitiva::className(), ['id' => 'fin_fatura_debito_cliente_id']);
    }
