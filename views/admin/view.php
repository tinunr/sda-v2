...
<p style="margin: 10px 0px; text-align: left; padding: 10px; border-left: 2px solid #ab162b; background: #f8f8f8;"><strong><i class="fa fa-user"></i> ACESSO </strong></p>
    ...
    <div class="col-md-2">
        <?= Html::submitButton($modelAuthAssignment->isNewRecord ? Yii::t('app', 'Adicinar') : Yii::t('app', 'Atualizar'), ['class' => $modelAuthAssignment->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
                ...
                'template' => '{delete}',
                 'buttons' => [
                        ...
                        'delete' => function ($url, $model) {
                            return Html::a('<i class="fa fa-remove"></i>  Eliminar', $url, [
