    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                return Html::a('<span style="color:#00afea" class="glyphicon glyphicon-eye-open"></span>', $url, [
        ...
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                return Html::a(' <span style="color:#00afea" class="glyphicon glyphicon-edit"></span> ', $url, [
                    'title' => Yii::t('yii', 'ATUTALIZAR'),
                    'data-pjax' => '0',
                ]);
            };
        }
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                return Html::a(' <span style="color:#00afea" class="glyphicon glyphicon-remove"></span> ', $url, [
                    'title' => Yii::t('yii', 'ELIMINAR'),
                    'data-confirm' => Yii::t('yii', 'PRETEENDE REALMENTE REMOVER ESTE REGISTO?'),
                    'data-method' => 'post',
                    'data-pjax' => '0',
                ]);
            };
